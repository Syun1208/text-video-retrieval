...
class ASRSearch(Translation):
    def __init__(self, dict_bert_search = os.path.join(WORK_DIR, 'data/dicts/keyframes_id_bert.json'), mode = "lit", show_time_compute=True):
        self.index = None
        self.mode = mode
        ...
        if self.mode == "lit":
            ...
            pass
    def load_bin_file(self, bin_file=os.path.join(WORK_DIR, f'models/faiss_asr_{mode_compute}.bin')):
